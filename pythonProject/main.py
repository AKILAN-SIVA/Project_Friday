...
def runfriday():
    ...
    if 'who are you' in command or 'name' in command or 'yourself' in command:
    ...
    elif 'mail' in command or 'gmail' in command or 'email' in command:
        try:
            talk('enter mail id')
            to = input("what is mail id: ")
        ...
        talk('how many seconds will i stop listening')
        stop = int(input('how many seconds: '))
        time.sleep(stop)
        stop = str(stop)
        print(stop + ' seconds completed. Now you can ask anything')
        talk(stop + ' seconds completed. Now you can ask anything')
